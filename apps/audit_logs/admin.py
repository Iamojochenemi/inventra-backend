...
class AuditLogAdmin(admin.ModelAdmin):
    list_display = ('id', 'action_badge', 'content_type', 'user', 'ip_address', 'created_at')
    list_filter = ('action', 'content_type', 'created_at', 'user')
    search_fields = ('user__email', 'ip_address', 'reason')
    readonly_fields = ('created_at', 'content_type', 'object_id', 'old_values', 'new_values', 'user_agent')
